...
const $thirdText = document.querySelectorAll('.visitors__third_text span');
const $third1 = $thirdText[0]
const $third2 = $thirdText[1]
...
if ($title && $introtext && $bubble1 && $thirdText && $bubble2 && $image) {
